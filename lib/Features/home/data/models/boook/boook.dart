...
class Boook extends Equatable {
  ...
  factory Boook.fromMap(Map<String, dynamic> data) => Boook(
  ...
  /// `dart:convert`
  ///
  /// Parses the string and returns the resulting Json object as [Boook].
  factory Boook.fromJson(String data) {
    return Boook.fromMap(json.decode(data) as Map<String, dynamic>);
  }

  /// `dart:convert`
  ///
  /// Converts [Boook] to a JSON string.
